...
function RenderLoudSpeakerSystem({ item }) {
    return (
        <Link to={`/loudspeakerSystem/${item.id}`} >
...
const LoudSpeakerSystem = (props) => {
    const featuredItemsMap = props.loudSpeakerSystems.map((item) => {
        return (<div key={item.id} className="col-6 col-md-4 mb-3">
            <RenderLoudSpeakerSystem item={item} />
        </div>);
    });
    return (
        <div className="products">
            <div className="row">
                <Breadcrumb >
                    ...
                    <BreadcrumbItem style={{ fontFamily: "Oswald,sans-serif !important" }} active>LoudSpeakerSystems</BreadcrumbItem>
                </Breadcrumb>
                <div className="col-12 m-3">
                    <h3 className='page-title'>LoudSpeakerSystems</h3>
...
export default LoudSpeakerSystem;